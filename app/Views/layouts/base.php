...
<meta property="og:site_name" content="<?= h($siteName) ?>"><?php if($ogImage): ?>
<meta property="og:image" content="<?= h($ogImage) ?>"><?php endif; ?><?php foreach ($enabledLocales as $locale): ?>
<link rel="alternate" href="<?= h($canonical) ?>" hreflang="<?= h($locale) ?>"><?php endforeach; ?>
