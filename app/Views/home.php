...
<?php if(empty($items)): ?>
  <div class="tw-bg-white tw-border tw-rounded-2xl tw-p-6 tw-text-center tw-text-gray-600">Bu kriterlere uygun soru bulunamadı.</div><?php else: ?>
...
<?php paginator($page,$per,$total); ?><?php $content = ob_get_clean(); include __DIR__.'/layouts/base.php'; ?>
